...
class HotkeyCategoryViewModel: ObservableObject {
    @Published var hotKeyCategoryViewModel: [HotkeyCategoryModel] = []
    init() {
        let productCategory: HotkeyCategoryModel = .init(name: "Product", hotkeymodel: [
            .init(
                modifiers: [.command],
                character: "b",
                text: "Build"),
        ...
        let schemeCategory: HotkeyCategoryModel = .init(name: "Scheme", hotkeymodel: [
            .init(
                modifiers: [.control],
                character: "0",
                text: "Choose scheme"),
            ...
            .init(
                 ...
                 character: "<",
                 text: "Edit scheme")])
        let hideOrShowPanelsCategory: HotkeyCategoryModel = .init(name: "Hide or Show Panels", hotkeymodel: [
        ...
        let inspectorCategory: HotkeyCategoryModel = .init(name: "Inspector", hotkeymodel: [
        ...
        let structureCategory: HotkeyCategoryModel = .init(name: "Structure", hotkeymodel: [
        ...
        let editingCategory: HotkeyCategoryModel = .init(name: "Editing", hotkeymodel: [
        ...
        let miscCategory: HotkeyCategoryModel = .init(name: "Miscellaneous", hotkeymodel: [
        ...
        let debuggingCategory: HotkeyCategoryModel = .init(name: "Debugging", hotkeymodel: [
        ...
        let fileMenuCommandsCategory: HotkeyCategoryModel = .init(name: "File menu commands", hotkeymodel: [
        ...
        let sourceControlCategory: HotkeyCategoryModel = .init(name: "Source Control", hotkeymodel: [
        ...
        hotKeyCategoryViewModel = [productCategory, schemeCategory, hideOrShowPanelsCategory, navigationCategory, inspectorCategory, structureCategory, editingCategory, miscCategory, debuggingCategory, fileMenuCommandsCategory, sourceControlCategory]
        }
}
